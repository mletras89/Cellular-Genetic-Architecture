...
set PROJECT systolicArray-Test-$BOARD
...
# reading vhdl files
read_vhdl ./vhd/systolic_array.vhd
read_vhdl ./vhd/systolic_array_pe.vhd
...
add_files -fileset sim_1 -norecurse ./vhd/tb_systolic_array.vhd
