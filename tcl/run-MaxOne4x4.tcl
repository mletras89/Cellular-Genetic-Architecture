...
read_vhdl ./genetic_operators/evaluators/Max-Ones/vhd/evaluator.vhd
...
#reading top
read_vhdl ./vhd/top_module4x4.vhd
...
add_files -fileset sim_1 -norecurse ./vhd/tb_top_module4x4.vhd
set_property top tb_top_module4x4 [get_filesets sim_1]
