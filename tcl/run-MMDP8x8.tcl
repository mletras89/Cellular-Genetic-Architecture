...
# reading vhdl files
read_vhdl ./vhd/datatypes_mmdp.vhd
read_vhdl ./vhd/processor_element_mmdp.vhd
read_vhdl ./vhd/register_bank_fitness_mmdp.vhd
read_vhdl ./vhd/register_bank_temporal_fitness_mmdp.vhd
read_vhdl ./vhd/register_bank_temporal_mmdp.vhd
read_vhdl ./vhd/register_bank_mmdp.vhd
...
add_files -fileset sim_1 -norecurse ./vhd/tb_processor_element_mmdp.vhd
set_property top tb_processor_element_mmdp [get_filesets sim_1]
